...
export const HeroSection = () => {
  ...
  return (
    <>
      <section
        className="  flex flex-col md:flex-col lg:flex-row  justify-center sm:justify-end h-[calc(100vh-64px)] bg-stone-100 -mt-16 md:mt-0 gap-10 md:px-28 
        px-7 "
        style={{
      ...
      >
        <div className="flex flex-col w-full max-w-2xl gap-12 md:gap-7 md:px-28 md:py-12 lg:py-16 xl:py-20 ">
          ...
          <div className="flex flex-col justify-center items-center lg:justify-start lg:items-center md:text-end">
            <ImgText
          ...
          <div className="flex flex-col justify-center items-center md:self-center lg:justify-start lg:items-start animate__animated animate__fadeInLeft animate__delay-1s md:text-center">
